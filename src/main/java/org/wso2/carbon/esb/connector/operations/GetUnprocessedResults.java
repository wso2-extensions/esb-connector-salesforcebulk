...
public class GetUnprocessedResults  extends AbstractConnector {
    ...
    public void connect(MessageContext messageContext) {
        try {
            ...
            String getJobUnprocessedResultsUrl = SalesforceUtils.getGetJobUnprocessedResultsUrl(salesforceConfig, jobId);
            messageContext.setProperty(SalesforceConstants.GET_UNPROCESSED_RESULTS_URL, getJobUnprocessedResultsUrl);
        } catch (Exception e) {
