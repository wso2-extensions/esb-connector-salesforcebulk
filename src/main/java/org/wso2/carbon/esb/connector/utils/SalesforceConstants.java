...
public class SalesforceConstants {
    ...
    public static final String CREATE_JOB_URL = "createJobUrl";
    public static final String CREATE_QUERY_JOB_URL = "createQueryJobUrl";
    public static final String DELETE_JOB_URL = "deleteJobUrl";
    public static final String DELETE_QUERY_JOB_URL = "deleteQueryJobUrl";
    public static final String ALL_JOB_INFO_URL = "allJobInfoUrl";
    public static final String ALL_QUERY_JOB_INFO_URL = "allQueryJobInfoUrl";
    public static final String GET_FAILED_RESULTS_URL = "getFailedResultsUrl";
    public static final String JOB_INFO_URL = "jobInfoUrl";
    public static final String QUERY_JOB_INFO_URL = "queryJobInfoUrl";
    public static final String GET_QUERY_JOB_RESULTS_URL = "getQueryJobResultsUrl";
    public static final String GET_SUCCESSFUL_RESULTS_URL = "getSuccessfulResultsUrl";
