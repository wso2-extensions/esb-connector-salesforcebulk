...
Steps to follow in setting integration test.
 ...
 4. If required place the X.509 certificate from https://{instance_name}.salesforce.com to location "<SALESFORCEBULK_CONNECTOR_HOME>/repository/".
 ...
 6. Following are the properties used in the 'esb-connector-salesforcebulk.properties' file and salesforcebulk properties file (<SALESFORCEBULK_CONNECTOR_HOME>/src/test/resources/artifacts/EI/connector/config/)repository to run the integration tests.
